CREATE TABLE IF NOT EXISTS `MahmoudMorsy`.`Volunteer` (
  ...
  FOREIGN KEY (`Committee_ID`)
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
    FOREIGN KEY (`Committee_Season`)
    REFERENCES `MahmoudMorsy`.`Committee` (`Season`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  UNIQUE INDEX `Vice_ID_UNIQUE` (`Vice_ID` ASC),
    ...
    ON UPDATE NO ACTION,
     FOREIGN KEY (`Season`)
    REFERENCES `MahmoudMorsy`.`Section` (`Season`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS `MahmoudMorsy`.`Request` (
  ...
  `Committee_Season` YEAR NOT NULL,
